...
char *test_l2_norm() {
  double vector[] = { 3, 4 };
  mu_assert(float_eq(l2_norm(vector, 2), 5.0, 0.001), "Wrong number value.");

  double vector2[] = { -3, 4 };
  mu_assert(float_eq(l2_norm(vector2, 2), 5.0, 0.001), "Wrong number value.");
